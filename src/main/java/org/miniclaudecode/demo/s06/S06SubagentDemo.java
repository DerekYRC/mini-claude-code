...
public class S06SubagentDemo {
	...
	public static void main(String[] args) {
		...
		AnthropicConfig parentConfig = config("You are a coding agent at " + System.getProperty("user.dir")
				+ ". For complex sub-problems, use the task tool to spawn a subagent. Act, don't explain.");
